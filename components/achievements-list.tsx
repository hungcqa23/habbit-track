...
const allAchievements = [
  ...
  // Habit categories
  {
    ...
    description: "Track 3 or more fitness habits",
    icon: Dumbbell,
    color: "text-red-500",
    category: "categories",
    difficulty: "intermediate",
  },
  {
    ...
    description: "Track 3 or more mindfulness habits",
    icon: Brain,
    color: "text-purple-500",
    category: "categories",
    difficulty: "intermediate",
  },
  {
    id: "learning-lover",
    name: "Learning Lover",
    description: "Track 3 or more learning habits",
    icon: BookOpen,
    color: "text-blue-500",
    category: "categories",
    difficulty: "intermediate",
  },
  {
    id: "health-hero",
    name: "Health Hero",
    description: "Track 3 or more health habits",
    icon: Heart,
    color: "text-red-500",
    category: "categories",
    difficulty: "intermediate",
  ...
  },
  {
    id: "goal-getter",
    name: "Goal Getter",
    description: "Reach your first habit goal",
    icon: Target,
    color: "text-indigo-500",
    category: "milestones",
    difficulty: "intermediate",
  },
  {
    ...
    description: "Maintain 3 habits with streaks of 30+ days",
    icon: Crown,
    color: "text-yellow-500",
    category: "milestones",
    difficulty: "expert",
