            ...
            <Tooltip>
              ...
              <TooltipContent className="bg-card border shadow-md">
                ...
                <p className="text-xs text-muted-foreground">
                  Increase by completing tasks that require effort and persistence
                </p>
              </TooltipContent>
            </Tooltip>
          </div>
          ...
          <div className="space-y-2.5 bg-card p-4 rounded-lg border border-border/50">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">Intelligence and problem-solving</div>
                </div>
              </div>
            ...
            <Tooltip>
              ...
              <TooltipContent className="bg-card border shadow-md">
                ...
                <p className="text-xs text-muted-foreground">
                  Increase by completing logic-based, educational, or strategic tasks
                </p>
              </TooltipContent>
            </Tooltip>
          </div>
